...
def CompItems(cursor, mainList):
	cursor.execute("CREATE TABLE comparison_item(compare_id int NOT NULL AUTO_INCREMENT, compare_name varchar(255) NOT NULL, compare_price int, store_id int, category_id int, PRIMARY KEY (compare_id))")
